...
const MatchCard = ({userImage, rating, name, game, address, time, solePoints, matchPlayed, playedFor}) => {
    ...
    return (
        <div className="max-w-6xl mx-auto shadow-gray-800 shadow-sm pt-4 my-4">
            <div className={'flex justify-between mx-4'}>
                ...
                <div className={'pl-4'}>
                    ...
                    <div className={'flex text-xl'}>
                        <div className={'font-bold py-1'}>Game to played: </div>
                    ...
                    <div className={'flex text-xl py-1 shadow-gray-800 shadow-sm rounded-full my-1 mt-2'}>
